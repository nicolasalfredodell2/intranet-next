      ...
      {!loadingMain && !error && mainNews[0] && (
        <div className="animated fadeIn row align-items-stretch">
          ...
          <div className="col-12 col-lg-7-5 mr-lg-0 pr-lg-1 mb-lg-0 d-flex">
            <div
              className="card border-0 p-3 p-lg-0 pointer rounded w-100 d-flex flex-column main-news-card"
              style={{ boxShadow: 'none', background: "none", borderBottomLeftRadius: 10, borderBottomRightRadius: 10 }}
